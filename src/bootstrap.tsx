...
// production (react, react-query, react-i18next) — declared shared in
...
// (src/pages/main.tsx) renders NO providers of its own, which is what lets it be
// reused unchanged across both.
